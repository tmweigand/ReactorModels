...
#             result[self.N :] = dqdt - self.rate_constant * (self.isotherm.q(c) - q)
#         else:
#             result[self.N :] = dqdt - self.rate_constant *
# c * (self.isotherm.q(c) - q)
...
# self.numerics.collocation.evaluate_gradient(C0, 0))
